...
public class Pengenalan {
     ...
     * ● Servlet adalah merupakan spesifikasi untuk membuat Web, dan dengan menggunakan Servlet, kita bisa menjalankan aplikasi
     *   Java Web di Web Server apapun yang sudah mengikuti standarisasi Servlet
