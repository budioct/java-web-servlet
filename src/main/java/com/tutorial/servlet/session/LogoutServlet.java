...
public class LogoutServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        session.invalidate(); // void invalidate() // Membatalkan session ini lalu melepaskan ikatan objek apa pun yang terikat padanya.

        resp.getWriter().println("Success Logout"); // PrintWriter getWriter() throws IOException // memberi respon ke client

        /**
         * Result:
         * url: localhost:8080/session/logout
         * Success Logout
         *
         * Cookies
         * Name          Value                              HttpOnly
